class PlayerArrow {
  ...
  display() {
    ...
    //código correto para verificar a velocidade.x maior que zero E posição.x maior que 400 para que a trajectory(tragetória) seja alterada
    // if (this.body.velocity.x > && this.body.position.x > ) {
